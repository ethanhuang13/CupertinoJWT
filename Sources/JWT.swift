...
public struct JWTAppConnectAPI: Codable {
    private struct Header: Codable {
        /// alg
        let algorithm: String = "ES256"
    ...
    public init(keyID: String, issID: String, aud: String, issueDate: Date, expireDuration: TimeInterval) {
        ...
        payload = Payload(issID: issID, aud: aud, issueDate: iat, expireDate: exp)
    }
